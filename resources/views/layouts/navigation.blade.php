            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="flex space-x-4">
                        <a href="{{ route('login') }}" class="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">Login</a>
                        <a href="{{ route('register') }}" class="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">Register</a>
                    </div>
                @endauth
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @else
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600 px-4">
                <a href="{{ route('login') }}" class="block text-gray-700 dark:text-gray-300 py-2">Login</a>
