<nav x-data="{ open: false }" class="bg-gray-900 text-white border-b border-gray-700">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="sm:hidden bg-gray-800">
        ...
        @else
            <a href="{{ route('login') }}" class="block px-4 py-2 text-sm hover:bg-gray-700">Login</a>
            <a href="{{ route('register') }}" class="block px-4 py-2 text-sm hover:bg-gray-700">Register</a>
        @endauth
    </div>
</nav>
